...
#include "P0722_InterfaceCharacter.generated.h"
...
UCLASS()
class UNREAL10TH_MYCPP_API AP0722_InterfaceCharacter : public ACharacter, public IStaminaInterface
{
	GENERATED_BODY()

public:
	// Sets default values for this character's properties
	AP0722_InterfaceCharacter();
...
protected:
	...
	int InputPriority = 0;
	float StaminaRecoveryWaitTime = 0.0f;
